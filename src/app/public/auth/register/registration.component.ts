...
import {ConfirmPasswordValidator} from '../../validators/confirm-passsword.validator';
...
export class RegisterComponent implements CognitoCallback {
  ...
  onInit() {
    ...
    this.form = new FormGroup({
        ...
        password: new FormControl(null, [Validators.required, MinLengthValidator('password', 8)]),
